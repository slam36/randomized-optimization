...
def main():
    ...
    oa.append(StandardGeneticAlgorithm(200, 100, 5, nnop[5]))
    oa.append(StandardGeneticAlgorithm(100, 100, 10, nnop[6]))
    oa.append(StandardGeneticAlgorithm(200, 100, 10, nnop[7]))

    with open('nn_spam_results_GA.csv', 'w') as csvfile:
        writer = csv.writer(csvfile)
